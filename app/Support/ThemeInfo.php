...
class ThemeInfo
{
    ...
    public static function fromJson(string $slug, string $path, array $json, bool $isActive): self
    {
        ...
        $info->isBuiltin = in_array($slug, ['panelica', 'starter', 'flavor', 'aurora', 'ember', 'ocean', 'forest', 'midnight', 'sunset', 'arctic', 'terra', 'neon', 'coral', 'slate', 'royal', 'mint', 'webkahost', 'oneploy']);
