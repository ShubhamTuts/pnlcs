...
<div class="pn-card mb-24" style="padding:20px 24px;">
    ...
    <div class="pn-actions">
        ...
        <a href="{{ route("client.ai.agent") }}" class="btn btn-outline">{{ __('client.dashboard.ask_agent') }}</a>
        <a href="{{ route("client.ai.index") }}" class="btn btn-outline">{{ __('client.dashboard.ai_credits') }} ({{ number_format($aiBalance ?? 0, 0) }})</a>
    </div>
</div>
